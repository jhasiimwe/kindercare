...
<body id="page-top" class="bg-gradient-info">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="activatePupil.php" onclick="return false;">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Activate pupil</span></a>
            </li>
            <hr class="sidebar-divider">

            <li class="nav-item">
                <a class="nav-link" href="deactivatePupil.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Deactivate pupil</span></a>
            </li>
            <hr class="sidebar-divider">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">STAFF ID</h1>
