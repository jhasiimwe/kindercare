            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="viewAssignment.php" method="post">
                     <p>Please set the date when the assignment will expire</p>
                     
                        <div class="row">
                        <div class="col-lg-6">
                        <div class="form-group">
                          <p>Date of assignment expiry </p>
                     <input type="date" name="dat" class="form-control form-control-user"
                     id="exampleInputEmail"  required>
                     </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group">
                        <p>Time of assignment expiry</p>
                     <input type="time" name="tim" class="form-control form-control-user"
                     ...
                     <div class="row">
                         <div class="col-sm-12">
                            <p class="text-warning">Please don't enter more than 8 letters and don't put spaces between the letters </p>
                         </div>
                         <div class="form-group">
                          <input type="text" pattern = "[A-Z]*" name="assign" class="form-control form-control-user" maxlength="8"
                    ...
                    <br>
                    <br>
                     <button type="submit" id="sub" name ='submit' class="btn btn-primary" value="Set assignment" >Set assignment</button>         
                    </form>
                     </div>
